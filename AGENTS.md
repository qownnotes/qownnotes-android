...
| QOwnNotesAPI | Optional Nextcloud companion used for server-side note versions and remote trash browsing/restoration | [Repository](https://github.com/pbek/qownnotesapi), [controller](https://github.com/pbek/qownnotesapi/blob/main/lib/Controller/NoteApiController.php) |
